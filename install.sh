...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY FLIXXHOST OFFC            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "agiadityatobrut" ]; then
    ...
    echo -e "${YELLOW}©FlixxHostOffc${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer Flixxhostotfc Public   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/FlixxOfficiall     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : FLIXXHOSTOFFC ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by FlixxHostOffc X Falzz  ${NC}"
